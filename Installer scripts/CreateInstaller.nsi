...
Section "Deathcounter and Soundboard (required)" SecApp
    ...
    File "..\DCSB\bin\Release\DCSB.exe.config"
    ...
    File "..\DCSB\bin\Release\Microsoft.Win32.Registry.dll"
    File "..\DCSB\bin\Release\NAudio.dll"
    File "..\DCSB\bin\Release\NAudio.Asio.dll"
    File "..\DCSB\bin\Release\NAudio.Core.dll"
    File "..\DCSB\bin\Release\NAudio.Midi.dll"
    File "..\DCSB\bin\Release\NAudio.Vorbis.dll"
    File "..\DCSB\bin\Release\NAudio.Wasapi.dll"
    File "..\DCSB\bin\Release\NAudio.WinForms.dll"
    File "..\DCSB\bin\Release\NAudio.WinMM.dll"
    ...
    File "..\DCSB\bin\Release\System.Resources.Extensions.dll"
    File "..\DCSB\bin\Release\System.Runtime.CompilerServices.Unsafe.dll"
    File "..\DCSB\bin\Release\System.Security.AccessControl.dll"
    File "..\DCSB\bin\Release\System.Security.Principal.Windows.dll"
    File "..\DCSB\bin\Release\System.Threading.Tasks.Extensions.dll"
    File "..\DCSB\bin\Release\System.ValueTuple.dll"
...
Section "uninstall"
    ...
    Delete "$INSTDIR\DCSB.exe.config"
