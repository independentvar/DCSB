...
- **Catches broken audio routing early** — Settings shows inline warnings when a device cannot be opened, outputs overlap, or microphone passthrough has nowhere useful to go.
